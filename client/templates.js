(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><div class="navbar navbar-inverse navbar-fixed-top"><div class="container"><div class="navbar-header"><button type="button" data-toggle="collapse" data-target=".navbar-collapse" class="navbar-toggle"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a href="/" class="navbar-brand">body(view)</a></div><div class="collapse navbar-collapse"><ul class="nav navbar-nav"><li class="active"><a href="/">home</a></li><li><a href="/users">users</a></li><li><a href="/detail/1">detail/1</a></li><li><a href="/um">um</a></li><li><a href="/dois">dois</a></li><li><a href="/tres">três</a></li></ul><p href="#" role="user-name" class="navbar-text navbar-right">some-user</p></div></div></div><div class="container"><div role="page-container" class="main"></div></div></body>';
    };

    // includes/user.jade compiled template
    templatizer["includes"]["user"] = function tmpl_includes_user() {
        return '<tr><td><span role="user-fullName-item"></span></td><td><button class="btn btn-default">Edit</button></td><td><button class="btn btn-default">Delete</button></td></tr>';
    };
